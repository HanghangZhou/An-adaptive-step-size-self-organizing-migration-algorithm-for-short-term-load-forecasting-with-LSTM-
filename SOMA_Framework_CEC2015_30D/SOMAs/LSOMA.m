...
function [RunResult,RunValue,RunTime,RunFES,RunOptimization,RunParameter]=LSOMA(problem,N,runmax)
'LSOMA'
...
%                 end
            ...
            while t<pathLength
                ...
                step = 0.7 - (n / Count) * 0.3; %step=max-(count/sum_count)*(max-min) max=0.7 min=0.4
            end
        end
